...
import logoSrc from "./../assets/BBX logo.webp"; // Assuming you have a logo image
...
const BarterCard = () => {
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <h1 className="mt-5 text-4xl text-[#0057A7] text-center">
        Program Details
      </h1>
      <div className="bg-white p-6 shadow-lg rounded-lg">
        <BarterCardTable />
        <h2 className="text-2xl text-[#0057A7] mb-4">
          How to Use Your BBX Digital Currency
        </h2>
        ...
        <h2 className="text-2xl text-[#0057A7] mt-8 mb-4">Example</h2>
        ...
        <h2 className="text-2xl text-[#0057A7] mt-8 mb-4">How It Works</h2>
        <ol className="list-decimal pl-5 space-y-4 text-gray-700 leading-6">
          <li>
        ...
        <h2 className="text-2xl text-[#0057A7] mt-8 mb-4">Summary</h2>
